        ...
        action.setCallback(this, function(response) {
            ...
            if(component.isValid() && state === "SUCCESS") {
                ...
                if(dataReceived.length==0){
                    var spinner = component.find("SNT_MRK_ListSpinner");
                    $A.util.toggleClass(spinner, "slds-hide");
                    $("#container_SNT_MRK").html('<div class="no-data-container"><div class="no-data-message">'+ component.get('v.nodata1') +'</div></div>');
                } else {
                    ...
                    Highcharts.chart('container_SNT_MRK', {
                        chart: {
                            type: 'bar',
                        },
                        title: {
