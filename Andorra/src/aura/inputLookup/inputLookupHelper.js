({
    ...
    */
    createTypeaheadComponent: function(component){
        ...
        var inputElement = $lCLookup('[id="'+globalId+'_typeahead"]');
    ...
    searchAction : function(component, q){
        ...
        action.setCallback(this, function(a) {
            ...
            $lCLookup.each(strs, function(i, str) {
    ...
    loadValue : function(component, skipTypeaheadLoading){
        ...
        action.setCallback(this, function(a) {
            ...
            if(result)$lCLookup('[id="'+globalId+'_typeahead"]').val(result || '');
