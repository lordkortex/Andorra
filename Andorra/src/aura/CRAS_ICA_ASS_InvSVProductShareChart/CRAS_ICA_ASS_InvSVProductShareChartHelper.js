({
	drawSVProductShareCount : function(component, event, helper) {
        
        var action = component.get("c.getReportPrimeCountSVProduct");
            ...
            if(component.isValid() && state === "SUCCESS") {
                ...
                if(dataReceived.length==0){
                    var spinner = component.find("productSVShareListSpinner");
                    $A.util.toggleClass(spinner, "slds-hide");
                    $("#containerPSV").html('<div class="no-data-container"><div class="no-data-message">' + component.get('v.nodata1') +'</div></div>');
                } else {
    ...
    drawSVProductShareInsureds : function(component, event, helper) {
		var action = component.get("c.getReportInsuredsSVProduct");
        ...
        action.setCallback(this, function(response) {
            ...
            if(component.isValid() && state === "SUCCESS") {
                ...
                if(dataReceived.length==0){
                    var spinner = component.find("productSVShareListSpinner");
                    $A.util.toggleClass(spinner, "slds-hide");
                    $("#containerPSV").html('<div class="no-data-container"><div class="no-data-message">' + component.get('v.nodata3') +'</div></div>');
                } else {
